...
def try_to_get_float(s: str):
    ...
    try:
        ...
        str_exception = 'Ошибка чтения матрицы! Недопустимая запись выражения: ' + s
        raise Exception(str_exception)
    except Exception as e:
        # print(s, "failed eval:", str(e), exprStack)
        str_exception = 'Ошибка чтения матрицы! Невозможно вычислить выражение: ' + s
        raise Exception(str_exception)
    else:
        return val
